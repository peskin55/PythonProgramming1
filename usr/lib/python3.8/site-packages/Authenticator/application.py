...
class Application(Gtk.Application):
    ...
    def _setup_css(self):
        ...
        provider.load_from_resource('/com/github/bilelmoussaoui/Authenticator/style.css')
        Gtk.StyleContext().add_provider_for_screen(Gdk.Screen.get_default(), provider,
                                                   Gtk.STYLE_PROVIDER_PRIORITY_USER)
        Gtk.IconTheme.get_default().add_resource_path("/com/github/bilelmoussaoui/Authenticator/icons")
